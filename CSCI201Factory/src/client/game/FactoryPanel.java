...
import client.components.FactoryNode;
import client.components.FactoryObject;
import client.components.FactoryWorker;
...
public class FactoryPanel extends JPanel {
    ...
    void render(FactorySimulation inFactorySimulation) {
        ...
        if (mWidth != getWidth() || mHeight != getHeight() || mImage == null) {
            ...
            double width = mFactoryWidth / inFactorySimulation.getWidth();
            double height = mFactoryHeight / inFactorySimulation.getHeight();
        ...
        for (FactoryNode[] nodes : inFactorySimulation.getNodes()) {
            for (FactoryNode node : nodes) node.draw(mGraphics, mouseLocation);
        }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (mImage != null) g.drawImage(mImage, 0, 0, null);
    }
