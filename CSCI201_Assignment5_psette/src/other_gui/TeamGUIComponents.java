...
public class TeamGUIComponents extends TeamData {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4625867871262907623L;
	// members for the main screen
	transient private JLabel mainTotalPointsLabel;
	transient public JLabel mainTeamNameLabel;
	// members for the final jeopardy screen

	// bug fix: all components with listeners need to have their listener
	...
	public void resetTeam() {
		...
		// remove all listeners from the components, we will add a new listener
		// next time around
	...
	// override addPoints and deductPoints from TeamData so it can also update
