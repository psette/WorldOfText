...
public class TeamData implements Serializable {
	private static final long serialVersionUID = -7116779451897236891L;
	...
	// called from GameData to deduct or add the bet amount depending on whether
	// they got the fj answer right
	...
	// it is passed into the sort method from the Java Collections class as a
	// custom comparator
