...
public class WinnersAndRatingGUINetworked extends WinnersAndRatingGUI {
	private static final long serialVersionUID = 2614250580896534480L;
	...
	protected void createRatingLabel() {
		currentRatingLabel = new JLabel(serverGameData.getAverageRating() == -1 ? "no rating"
				: "current average rating : " + serverGameData.getAverageRating() + "/5", JLabel.CENTER);
	}
