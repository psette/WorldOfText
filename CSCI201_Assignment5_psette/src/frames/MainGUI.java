...
public class MainGUI extends JFrame {
	private static final long serialVersionUID = -4888571713545953666L;
	...
	public void setLabel(String text) {
		jeopardyLabel.setText("Jeopardy " + text);
	}

	public MainGUI(GameData gameData) {
		super("Jeopardy!!");
		teams = new JLabel[gameData.getNumberOfTeams()];
	...
	// move constructor logic to a protected method so MainGUINetworked can call
	// it
	...
	// we want to override this in MainGUINetworked which is why I pulled the
	// logic out into its own method
	...
	private JPanel createProgressPanel() {
		...
		for (int i = 0; i < gameData.getNumberOfTeams(); i++) {
			...
			teams[i] = team.getMainTeamNameLabel();
			pointsPanel.add(teams[i]);
	...
	// adding even listeners, made this protected so MainGUINetworked can
	// override it
