...
public class QuestionClickedAction extends Action {
	...
	public void executeAction(MainGUINetworked mainGUI, ServerGameData gameData, Message message, Client client) {
		...
		// set the current question on the client using the indices provided in
		// the message
		...
		// change to question panel, update number of chosen questions in game
		// data, and set this question to asked
