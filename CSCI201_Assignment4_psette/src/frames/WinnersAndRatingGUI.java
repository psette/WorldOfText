...
public class WinnersAndRatingGUI extends JFrame {
	private static final long serialVersionUID = 3769760575663767823L;
	...
	private void createGUI() {
		...
		JLabel currentRatingLabel = new JLabel(
				gameData.getGameFile().getNumberOfRatings() == -1 ? "no rating"
						: "current average rating : " + gameData.getGameFile().getAverageRating() + "/5",
				JLabel.CENTER);
		...
		AppearanceSettings.setBackground(AppearanceConstants.lightBlue, okayPanel, winners, andTheWinnersAre,
				ratingChoiceLabel, mainPanel, sliderPanel, ratingInstructionsLabel, currentRatingLabel,
		...
		AppearanceSettings.setTextAlignment(ratingInstructionsLabel, currentRatingLabel, ratingChoiceLabel,
				andTheWinnersAre);
