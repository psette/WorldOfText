...
public class MainGUI extends JFrame implements Serializable {
	private static final long serialVersionUID = 4862918115883680561L;
	...
	public MainGUI(GameData gameData, User user, boolean networked, GameClient gameClient, boolean isHost) {
		super("Jeopardy!!");
	...
	public void addUpdate(String update) {
		if (networked) {
			this.gameClient.sendNetworkMessage(new AddUpdate(update));
		}
		updatesTextArea.append("\n" + update);
	}

	public void addUpdateNonRecur(String update) {
		updatesTextArea.append("\n" + update);
	}
