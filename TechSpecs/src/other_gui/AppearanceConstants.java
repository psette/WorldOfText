...
public class AppearanceConstants {
	...
	public static final Font fontSmall = new Font("Garamond", Font.BOLD,18);
	public static final Font fontSmallest = new Font("Garamond", Font.BOLD,14);
	public static final Font fontMedium = new Font("Garamond", Font.BOLD, 22);
	public static final Font fontLarge = new Font("Garamond", Font.BOLD, 30);
	public static final Font fontXL = new Font("Garamond", Font.BOLD, 50);
